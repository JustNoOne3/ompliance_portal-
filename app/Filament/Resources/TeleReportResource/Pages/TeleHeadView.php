...
class TeleHeadView extends Page implements HasForms, HasInfolists
{
    ...
    protected static string $view = 'filament.resources.tele-report-resource.pages.tele-head-view';
