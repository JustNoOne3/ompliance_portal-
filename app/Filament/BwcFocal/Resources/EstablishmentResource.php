                        ...
                        Tab::make('Certification')
                            ...
                            ->schema([
                                ...
                                Section::make()
                                    ->columns(3)
                                    ->schema([
                                        Forms\Components\TextInput::make('est_tenNum')
                                            ->maxLength(255)
                                            ->label('Telephone No.'),
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('psic_section')
                    ...
                    ->searchable(),
                Tables\Columns\TextColumn::make('psic_division')
                    ->label('Nature of Business')
                    ->toggleable(isToggledHiddenByDefault: true)
                    ->searchable(),
                Tables\Columns\TextColumn::make('psic_group')
                    ->label('Nature of Business')
                    ->toggleable(isToggledHiddenByDefault: true)
                    ->searchable(),
                Tables\Columns\TextColumn::make('psic_class')
                    ->label('Nature of Business')
                    ->toggleable(isToggledHiddenByDefault: true)
                    ->searchable(),
